$(document).ready(function() {
    ...
    $.p1s.profile = {};
    $.p1s.profile.url = {};
    $.p1s.profile.url.fetch = "http://localhost:8080/plusoneseat/php/php/api/getProfile.php";
    $.p1s.profile.url.save =  "http://localhost:8080/plusoneseat/php/php/api/updateProfile.php";
